...
export default function TeachersTrainingSection() {
    return (
        <section className="py-8 md:py-10 bg-white overflow-hidden" aria-labelledby="teachers-training-heading">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <motion.div
                    ...
                    className="mb-8 md:mb-10 md:text-center max-w-3xl md:mx-auto"
                >
