...
export default function HeroCarousel() {
    ...
    return (
        <div className="w-full lg:w-[45%] relative min-h-[50vh] lg:min-h-full">
            ...
            {/* Gradient — mobile */}
            <div className="absolute inset-0 bg-gradient-to-t from-[#0D7A82] via-transparent to-transparent lg:hidden z-10" />
            {/* Gradient — desktop left edge blend */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#0D7A82] via-transparent to-transparent hidden lg:block w-32 left-0 z-10" />
        </div>
    );
}
